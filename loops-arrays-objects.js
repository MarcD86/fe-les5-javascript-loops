...
for (let i = 0; i < students.length; i++) {
    if (students[i].zipCode === '3513') {
        students[i].neighborhood = students[i].neighborhood = 'Pijlsweerd';
        console.log(students[i])
    }
    if (students[i].zipCode === '3514') {
        students[i].neighborhood = students[i].neighborhood = 'Vogelenbuurt';
        console.log(students[i])
    }
    if (students[i].zipCode === '3512') {
        students[i].neighborhood = students[i].neighborhood = 'Binnenstad';
        console.log(students[i])
    }
    if (students[i].zipCode === '3531') {
        students[i].neighborhood = students[i].neighborhood = 'Lombok';
        console.log(students[i])
    }
    if (students[i].zipCode === '3572') {
        students[i].neighborhood = students[i].neighborhood = 'Wittevrouwen';
        console.log(students[i])
    }
    if (students[i].zipCode === '3581') {
        students[i].neighborhood = students[i].neighborhood = 'Oudwijk';
        console.log(students[i])
    }
    if (students[i].zipCode === '3583') {
        students[i].neighborhood = students[i].neighborhood = 'Schildersbuurt';
        console.log(students[i])
    }
// verwachtte uitkomsten klopt niet helemaal ... alles is vogelenbuurt :p
}
